  ...
  return (
    ...
    <div className='flex absolute gap-[30vw] top-3 gap-x-[40vw] justify-between z-50'>
      <div className="left-part">
        <img onClick={()=>Navigate('/home')} className='h-20 cursor-pointer pl-4' src="https://fantasy-extreme-assets.s3.us-east-005.backblazeb2.com/Compressed/logo/logo.png" alt="" />
      </div>
      <div className="right-part flex flex-col">
        <ul className='right-list flex flex-row pr-11 gap-4 m-4 p-2 rounded-2xl border-[0.1vw] border-[#68ed94] bg-[#0C0C19] text-white text-sm justify-center items-center'>
          ...
          <Link to='/rewardCalculator'>
            <li className='cursor-pointer hover:text-gGlow w-40  transition-all duration-1000'>Rewards Calculator</li>
          </Link>
          
          <li className='cursor-pointer hover:text-gGlow transition-all ml-4 duration-1000'><Component></Component></li>
          <Link to="/fantasyextremeRules">
            <li className='cursor-pointer hover:text-gGlow transition-all w-32 duration-1000'>Gameplay Rules</li>
          </Link>
          <li>
